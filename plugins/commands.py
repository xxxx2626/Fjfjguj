...
from config import Var, AUTH_CHANNEL, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, AUTO_DELETE_TIME, AUTO_DELETE, ADMINS, BIN_CHANNEL, URLS
import re
import json
import base64
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        for msg in msgs:
            ...
            if f_caption is None:
                f_caption = f"{title}"
            try:
                h = await message.reply_text(f"<b><u>⚠️ᴛʜɪs ғɪʟᴇ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ᴀғᴛᴇʀ 30 ᴍɪɴᴜᴛᴇs\n\nᴘʟᴇᴀsᴇ ғᴏʀᴡᴀʀᴅ ᴛʜᴇ ғɪʟᴇ sᴏᴍᴇᴡʜᴇʀᴇ ʙᴇғᴏʀᴇ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ..</b>")
...
# Ask Doubt on telegram @KingVJ01
        ...
        await message.reply_text(f"<b><u>⚠️ᴛʜɪs ғɪʟᴇ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ᴀғᴛᴇʀ 30 ᴍɪɴᴜᴛᴇs\n\nᴘʟᴇᴀsᴇ ғᴏʀᴡᴀʀᴅ ᴛʜᴇ ғɪʟᴇ sᴏᴍᴇᴡʜᴇʀᴇ ʙᴇғᴏʀᴇ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ..</b>")
...
# Ask Doubt on telegram @KingVJ01
    ...
    if not files_:
        ...
        try:
            ...
            await msg.delete()
            await g.delete()
            await k.edit_text("<b>ʏᴏᴜʀ ғɪʟᴇ ᴡᴀs ᴅᴇʟᴇᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ ᴀғᴛᴇʀ 15 ᴍɪɴᴜᴛᴇs ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ 📢</b>")
            return
        except:
            pass
...
# Ask Doubt on telegram @KingVJ01
       ...
       await client.edit_message_media(
           query.message.chat.id, 
           query.message.id, 
           InputMediaPhoto("https://graph.org/file/ba90cca85a5f2631f1139.jpg")
       )
       ...
       await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('ꜱᴜʙꜱᴄʀɪʙᴇ  ᴍʏ  ʏᴛ  ᴄʜᴀɴɴᴇʟ', url="https://youtube.com/@avbotx"),
        ],[
            InlineKeyboardButton('ɢʀᴏᴜᴘ', url="https://t.me/+X3uoMkIHhco1YTY1"),
...
# Ask Doubt on telegram @KingVJ01
        ...
        AKS = await client.send_cached_media(
            chat_id=BIN_CHANNEL,
            file_id=file_id)
        online = f"{STREAM_LINK if STREAM_LINK else URLS}/watch/{AKS.id}?hash={get_hash(AKS)}"
        download = f"{STREAM_LINK if STREAM_LINK else URLS}/{AKS.id}?hash={get_hash(AKS)}"
        btn= [[
